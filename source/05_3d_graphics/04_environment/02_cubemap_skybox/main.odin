...
light := Light{
    glm.normalize(glm.vec3{0.86219764, 0.2941049, -0.41245311}),
    {0.98, 0.73, 0.56}
}
...
SKYBOX_FS :: GLSL_VERSION + `
    ...
    void main() {
        o_frag_color = texture(u_skybox, v_tex_coord);
    }
`
...
load_cubemap :: proc() -> u32 {
    // Source: https://freestylized.com/skybox/sky_13/
    face_data := [6][]byte {
