...
MAIN_FS :: GLSL_VERSION + `
    ...
    void main() {
        ...
        vec4 emission_sample = texture(u_emission_tex, v_tex_coord);
        vec3 emission = emission_sample.rgb * emission_sample.a;
...
main :: proc() {
    ...
    loop: for {
        ...
        gl.Uniform1i(main_uf["u_emission_tex"].location, 1)
