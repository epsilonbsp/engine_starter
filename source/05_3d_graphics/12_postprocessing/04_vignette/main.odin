...
WINDOW_TITLE :: "Vignette"
WINDOW_WIDTH :: 960
WINDOW_HEIGHT :: 540
GL_VERSION_MAJOR :: 4
GL_VERSION_MINOR :: 6

VIGNETTE_VS :: b.LIGHTING_VS

VIGNETTE_FS :: b.GLSL_VERSION + `
    in vec2 v_tex_coord;
...
main :: proc() {
    ...
    loop: for {
        ...
        gl.UseProgram(vignette_pg)
        gl.ActiveTexture(gl.TEXTURE0)
        gl.BindTexture(gl.TEXTURE_2D, base.scene_buffer.color_tex)
        gl.Uniform1i(vignette_uf["u_scene_color"].location, 0)
        gl.Uniform1f(vignette_uf["u_exposure"].location, base.exposure)
        gl.Uniform1i(vignette_uf["u_debug_buffer"].location, base.debug_buffer)
        gl.Uniform1i(vignette_uf["u_enable_pp"].location, i32(enable_pp))
        gl.Uniform1f(vignette_uf["u_vignette_strength"].location, vignette_strength)
